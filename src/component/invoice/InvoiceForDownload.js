        ...
        <Page size="A4" style={styles.page}>
          <View style={styles.invoiceFirst}>
            <View>
              ...
              <Text style={styles.title}>Trạng thái : {data?.status}</Text>
            </View>
          ...
          <View style={styles.invoiceSecond}>
            ...
            <View>
              ...
              <Text style={styles.title}>#{data?.invoice}</Text>
            </View>
            <View>
              <Text style={styles.title}>MÃ HÓA ĐƠN</Text>
          ...
          <View style={styles.table}>
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>
                  <Text style={styles.header}>TÊN SẢN PHẨM</Text>
                </Text>
              </View>
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>
              ...
              <View style={styles.tableCol}>
                <Text style={styles.tableCell}>
                  {" "}
                  <Text style={styles.header}>TỔNG</Text>
                </Text>
              </View>
            </View>
          ...
          <View style={styles.invoiceThird}>
            ...
            <View>
              <Text style={styles.title}>PHÍ VẬN CHUYỂN</Text>
              <Text style={styles.title}>
                {Intl.NumberFormat("vi-VN", {
                  style: "currency",
                  currency: currency,
          ...
          >
            <Text style={styles.title}>
              Cám ơn <Text style={styles.title}>{data.name},</Text> Đơn hàng của
              bạn đã được nhận!
            </Text>
          </View>
        </Page>
