                ...
                <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
                  <div className="info flex items-center">
                    <div className="w-full">
                      <div className="block">
                        <div className="font-serif border border-dashed bg-yellow-100 py-1 border-yellow-500 rounded-lg text-center block">
                          <CopyToClipboard
                          ...
                          >
                            <button className="block w-full">
                              {copied && coupon.couponCode === copiedCode ? (
                                <span className="text-green-600 text-sm leading-7 font-semibold">
                                  {t("common:Copied")}
                                </span>
                              ) : (
                                <span className="uppercase font-serif font-semibold text-sm leading-7 text-green-600">
                                  {coupon.couponCode}{" "}
                                </span>
                              )}
                            </button>
                        ...
                        * {t("common:CouponDiscription")}{" "}
                        <span className="font-bold">
                          {Intl.NumberFormat("vi-VN", {
                            style: "currency",
                            currency: currency,
                          }).format(Number(coupon.minimumAmount))}
                        </span>{" "}
                      </p>
                    </div>
                  </div>
