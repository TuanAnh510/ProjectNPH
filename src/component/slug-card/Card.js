    ...
    <ul className="my-0">
      {/* <li className="flex items-center py-3">
        ...
        <p className="font-sans leading-5 text-sm text-gray-500">
          Miễn phí vận chuyển áp dụng cho tất cả các đơn đặt hàng qua vận chuyển
      ...
      <li className="flex items-center py-3">
        ...
        <p className="font-sans leading-5 text-sm text-gray-500">
          <span className="font-semibold">7</span> ngày đổi trả hàng
        </p>
      </li>
      ...
      <li className="flex items-center py-3">
        ...
        <p className="font-sans leading-5 text-sm text-gray-500">
          Sản phẩm chính hãng, có tem chống hàng giả
        </p>
      </li>
      {/* <li className="flex items-center py-3">
        <span className="text-xl text-gray-400 items-start mr-4">
