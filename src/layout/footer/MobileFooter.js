...
const MobileFooter = () => {
  ...
  const { toggleCartDrawer, toggleCategoryDrawer, toggleCartRentDrawer } = useContext(SidebarContext);
  ...
  return (
    <>
      ...
      <footer className="lg:hidden fixed z-30 bottom-0 bg-green-600 flex items-center justify-between w-full h-16 px-3 sm:px-10">
        <button
          aria-label="Bar"
        ...
        >
          ...
          <BsFillEasel3Fill className="w-6 h-6 drop-shadow-xl" />
